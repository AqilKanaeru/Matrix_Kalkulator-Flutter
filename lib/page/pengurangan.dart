...
import 'package:matrix_kk/page/perkalian.dart';

class PenguranganPage extends StatefulWidget {
  const PenguranganPage({Key? key}) : super(key: key);

  @override
  State<PenguranganPage> createState() => _penjumlahanpageState();
}

class _penjumlahanpageState extends State<PenguranganPage> {
  int a = 0;
  int b = 0;
  int c = 0;
  int d = 0;
